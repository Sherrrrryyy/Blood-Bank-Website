      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            <a
              href="/signup"
              className="text-red-900 bg-red-200 p-2 rounded-full hover:bg-red-900 hover:text-red-200 transition duration-300"
            >
              Signup
            </a>
            <div className="relative">
              <button className="text-white hover:text-red-200 transition duration-300">
                <svg
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <a
              href="/"
              className="block text-white hover:text-red-200 transition duration-300"
            >
              Home
            </a>
            <a
